...
class Model(nn.Module):
    def __init__(self, args, ckp):# ckp是checkpoint
        ...
        module = import_module('model.' + args.model.lower()) # 动态导入模块？
    ...
    def forward_chop(self, x, shave=10, min_size=160000):
        ...
        h, w = scale * h, scale2 * w
        h_half, w_half = scale * h_half, scale2 * w_half
        h_size, w_size = scale * h_size, scale2 * w_size
        shave *= scale
