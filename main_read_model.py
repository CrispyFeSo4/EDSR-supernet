...
if checkpoint.ok:
    ...
    #------------------------------------------
    state_dict = torch.load('/home/zwy/Meta-SR-Pytorchv5/experiment/edsr_layer_v2/model/edsr_layer_v2_same_model_100.pt')
    new_state_dict = {}
    for key, value in state_dict.items():
        name = key
        if 'conv1' in key:
            name = key.replace('conv1', 'body.0')
        elif 'conv2' in key:
            name = key.replace('conv2', 'body.2')
        name = 'model.'+ name
